...
r3 = [
    ...
    ["fig4_3b_adjust_profile", "图 4-3b 合约调整量的日内分布与阶段分解", "q4_target_days_interval.csv; q4_hourly_profile.csv",
     "slot; q−x; price_template", "334 日 × 144 段", "正负双向柱 + 电价折线", F],
    ["fig4_4a_soc_trajectory", "图 4-4a 指定日期储电量轨迹", "q4_target_days_interval.csv",
     "date; slot; S", "4 日 × 145 点 × 2 变体", "折线（线型区分变体 + 边界虚线）", F],
    ["fig4_4b_soc_distribution", "图 4-4b 储电量分布与边界触及", "q4_soc_hist.csv",
     "bin_lo; bin_hi; count_42; count_43", "48 箱 × 2 变体", "阶梯直方图 + 边界竖线", F],
